...
import {createRepo,getRepoByUser,getRepoInfo,updateRepo,deleteRepo,getAllPublicRepos} from "../controllers/repo.controller.js";
...
router.route("/public").get(verifyJWT,getAllPublicRepos) //all all public repos 
